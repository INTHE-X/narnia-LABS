...
<div class="content-header">
    <div class="content-header-inner"><h1 class="page-title">테크블로그 등록</h1></div>
</div>
<div class="content-body">
    <div class="card">
        <div class="card-header"><div class="card-title">테크블로그 정보 입력</div></div>
        @if($errors->any())
        ...
        @endif
        <form action="{{ route('tech-blogs.store') }}" method="POST" enctype="multipart/form-data" id="tb-form">
            @csrf
            <div class="img-form-layout" style="grid-template-columns:360px 1fr;">
                ...
                <div class="img-form-panel">
                    ...
                    <span class="img-form-hint">클릭하여 썸네일 선택<br>JPG, PNG (최대 5MB)<br><small style="color:#aaa;">권장 비율: 16:9 (가로형)</small></span>
                </div>
                {{-- 오른쪽: 입력 필드 --}}
                <div class="field-rows">
                    <div class="field-row">
                        <div class="field-label">제목 *</div>
                        <div class="field-value"><input type="text" name="title" value="{{ old('title') }}" placeholder="테크블로그 제목 (국문)" required></div>
                    </div>
                    <div class="field-row">
                    ...
                    <div class="field-row">
                        ...
                        <div class="field-value"><input type="date" name="published_date" value="{{ old('published_date', date('Y-m-d')) }}"></div>
                    </div>
                    <div class="field-row">
