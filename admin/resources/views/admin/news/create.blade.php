                ...
                <div class="field-rows">
                    ...
                    <div class="field-row align-top">
                        ...
                        <div class="field-value" style="padding-top:12px;padding-bottom:12px;">
                            <textarea name="content" rows="4" placeholder="기사 내용 요약">{{ old('content') }}</textarea>
                        </div>
                    </div>
                    <div class="field-row align-top">
                        <div class="field-label">Content (English)</div>
                        <div class="field-value" style="padding-top:12px;padding-bottom:12px;">
                            <textarea name="content_en" rows="4" placeholder="Content in English">{{ old('content_en') }}</textarea>
                        </div>
                    </div>
                    <div class="field-row align-top">
                        <div class="field-label">내용 (일문)</div>
                        <div class="field-value" style="padding-top:12px;padding-bottom:12px;">
                            <textarea name="content_jp" rows="4" placeholder="Content in Japanese">{{ old('content_jp') }}</textarea>
                        </div>
                    </div>
                </div>
            </div>
