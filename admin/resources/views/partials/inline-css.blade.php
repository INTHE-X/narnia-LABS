<style>
/* ==========================================================
   Narnia Labs Admin — admin.css
   디자인 전용 파일 (PHP 로직과 완전히 분리)
   HTML/CSS/JS로만 수정하세요
   ========================================================== */
...
:root {
    ...
    --box-shadow-md: 0 4px 12px rgba(0,0,0,0.10);
...
.content-header {
    background: var(--content-bg);
    padding: 28px var(--content-padding) 0;
}
...
.stat-icon.black { background: var(--black); }
.stat-icon.gray { background: var(--gray-200); }
.stat-icon svg {
    width: 20px;
    height: 20px;
    color: var(--white);
}
.stat-icon.gray svg { color: var(--gray-600); }
